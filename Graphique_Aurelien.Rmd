...
***Objectif du graphique :***  
Ici, nous allons répondre à la question suivante : **Face à quel type adverse chaque type de Pokémon est-il meilleur ?**
...
ggplot(heatmap_data, aes(x = type1, y = against_type, fill = mean_value)) +
  ...
  labs(
    title = "Heatmap des moyennes des coefficients de dégâts infligés par type, pour chaque type adverse",
    x = "Type du Pokémon attaqué",
    y = "Type du Pokémon qui attaque"
  )
```
