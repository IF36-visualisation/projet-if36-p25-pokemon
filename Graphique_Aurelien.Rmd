...
# 2. Relation entre les attaques / types
***Code et Visualisation***  
```{r warning=FALSE}
library(ggplot2)
library(dplyr)
...
ggplot(heatmap_data, aes(x = against_type, y = type1, fill = mean_value)) +
  ...
  scale_fill_gradient(low = "blue", high = "red", name = "Moyenne") +
  theme_minimal() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1)) +
  labs(
    title = "Heatmap des moyennes des coefficients 'against' par type ",
    x = "Type de résistance",
    y = "Type de Pokémon"
  )
```
