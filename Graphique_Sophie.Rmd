...
Tout d'abord, nous n'observons pas de relation particulière entre la taille et le poids d'une Pokémon. Au niveau de la distribution, il semble y avoir plus de Pokémon légers (< 100kg) et d'une taille moyenne ou petits (< 2m). Il n'y a quasiment pas de Pokémon à la fois petit (< 1m) et lourd (> 150kg).
